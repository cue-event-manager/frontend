...
import { Box, Grid, TextField, Typography, Button, IconButton, Paper, Stack, Divider, Fade } from "@mui/material";
...
export default function StepAgenda() {
    ...
    const handleAddItem = () => {
        append({ title: "", description: "", startTime: "", endTime: "" });
    };

    return (
        <Box sx={{ mt: 1 }}>
            <FormSection
                title={t("events.sections.agenda")}
                subtitle={t("events.labels.activity", "Define las actividades y horarios del evento")}
                actions={
                    <Button
                        variant="contained"
                        startIcon={<AddIcon />}
            ...
            >
                {fields.length === 0 ? (
                    ...
                    >
                        <EventNoteIcon sx={{ fontSize: 56, color: "text.disabled", mb: 1.5 }} />
                                        ...
                                        <Grid container spacing={2}>
                                            <Grid size={{ xs: 12 }}>
                                                <TextField
                                                    ...
                                                    helperText={String(errors.agenda?.[index]?.title?.message ?? " ")}
                                                />
                                            </Grid>
